...
import { PLATFORM_FEATURES, TOTAL_FEATURES, FEATURE_MAP, DYNAMIC_COUNTS, getFeaturesByCategory } from '@/constants/platformFeatureInventory';
...
export const useProfessionalJourney = (professionalId) => {
  ...
  const loadData = useCallback(async () => {
    ...
    try {
      // Buscar features usadas + automações em paralelo
      const [usageData, automationsRes, goal] = await Promise.all([
