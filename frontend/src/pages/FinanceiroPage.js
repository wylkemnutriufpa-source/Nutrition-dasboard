    ...
    <Layout title="Gestão Financeira" userType={profile?.role || 'professional'}>
      <div className="max-w-7xl mx-auto space-y-6 pb-8">
        ...
        <div className="relative overflow-hidden rounded-3xl shadow-2xl">
          <div className="bg-gradient-to-br from-slate-900 via-emerald-900 to-green-900 p-6 md:p-8 text-white relative">
            ...
            <div className="relative z-10">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <h1 className="text-2xl md:text-3xl font-black tracking-tight">Gestao Financeira</h1>
                    <p className="text-emerald-300 text-sm">Controle de entradas e saidas</p>
                  </div>
                </div>
                <div className="flex items-center gap-3">
                  ...
                  <Button onClick={openAddModal} className="bg-white/15 text-white hover:bg-white/25 border border-white/20 backdrop-blur-sm shadow-lg">
              ...
              <div className="grid grid-cols-3 gap-4 max-w-lg mt-4">
                <div className="text-center bg-white/10 rounded-xl p-3">
                  <p className="text-2xl font-black text-green-300">{formatBRL(totalIncome)}</p>
                  <p className="text-xs text-white/60">Receita</p>
                </div>
                <div className="text-center bg-white/10 rounded-xl p-3">
                  <p className="text-2xl font-black text-red-300">{formatBRL(totalExpense)}</p>
                  <p className="text-xs text-white/60">Despesa</p>
                </div>
                <div className="text-center bg-white/10 rounded-xl p-3">
                  <p className={`text-2xl font-black ${balance >= 0 ? 'text-green-300' : 'text-red-300'}`}>{formatBRL(balance)}</p>
